class User < ApplicationRecord
  ...
  validates :first_name, :first_name_furigana, format: { with: /\A[ァ-ヶー－]+\z/, message: "全角カタカナでご入力下さい"}
  validates :first_name, :last_name_furigana, format: { with: /\A[ァ-ヶー－]+\z/, message: "全角カタカナでご入力下さい"}
